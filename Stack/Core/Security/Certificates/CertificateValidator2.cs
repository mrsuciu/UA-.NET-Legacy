...
namespace Opc.Ua
{
    ...
    /// </summary>
    public class CertificateValidator2 : ICertificateValidator
    {
        #region Constructors
        /// <summary>
        /// The default constructor.
        /// </summary>
        public CertificateValidator2()
        {
        ...
        public event CertificateValidationEventHandler2 CertificateValidation
        {
            add
            {
                lock (m_callbackLock)
            ...
            catch (ServiceResultException se)
            {
                ...
                lock (m_callbackLock)
                {
                    do
                    {
                        ...
                        {
                            CertificateValidationEventArgs2 args = new CertificateValidationEventArgs2(serviceResult, certificate);
        ...
        public void ValidateDomains(X509Certificate2 serverCertificate, ConfiguredEndpoint endpoint)
        {
            ...
            if (!domainFound)
            {
                ...
                if (m_CertificateValidation != null)
                {
                    var args = new CertificateValidationEventArgs2(new ServiceResult(serviceResult), serverCertificate);
                    m_CertificateValidation(this, args);
        ...
        private event CertificateValidationEventHandler2 m_CertificateValidation;
    ...
    /// </summary>
    public class CertificateValidationEventArgs2 : EventArgs
    {
        #region Constructors
        /// <summary>
        /// Creates a new instance.
        /// </summary>
        internal CertificateValidationEventArgs2(ServiceResult error, X509Certificate2 certificate)
        {
            m_error = error;
    ...
    /// </summary>
    public delegate void CertificateValidationEventHandler2(CertificateValidator2 sender, CertificateValidationEventArgs2 e);
    #endregion
    ...
    /// </summary>
    public delegate void CertificateUpdateEventHandler(CertificateValidator2 sender, CertificateUpdateEventArgs e);
